...
User.destroy_all
User.create(:fname => "Thuan 1", :lname => "Vu", :email => "dinhthuan1@gmail.com", :password => "123456")
User.create(:fname => "Thuan 2", :lname => "Vu", :email => "dinhthuan2@gmail.com", :password => "123456")
User.create(:fname => "Thuan 3", :lname => "Vu", :email => "dinhthuan3@gmail.com", :password => "123456")
User.create(:fname => "Thuan 4", :lname => "Vu", :email => "dinhthuan4@gmail.com", :password => "123456")
User.create(:fname => "Thuan 5", :lname => "Vu", :email => "dinhthuan5@gmail.com", :password => "123456")
